    ...
    <div>
      ...
      <div className="EmailSection flex">
          ...
          <div className=" ml-20 mt-12 ">
            <h1 className="text-orange-500 text-base font-normal text-start" >WHY CHOOSE US</h1>
            ...
            <div>
              <div className="flex">
                ...
                <h1 className="ml-5 text-xl text-blue-100 font-normal">Corporate Financial Advisory</h1>
              </div>
              <div className="flex mt-5">
              <img src={Right2Logo} alt="Right2Logo" />
                <h1 className="ml-5 text-xl text-blue-100 font-normal">Development of Financial Models</h1>
              </div>
              <div className="flex mt-5">
              <img src={Right2Logo} alt="Right2Logo" />
                <h1 className="ml-5 text-xl text-blue-100 font-normal">Deal Structuring</h1>
              </div>
            </div>
            ...
            <input
              ...
              />
              <button  href="/" className="GetButton2 ">Get Started</button>
            </div>
          </div>
      </div>
    </div>
